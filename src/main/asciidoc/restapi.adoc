...
operations.
include::{snippets}/by-mouse-genes/response-fields.adoc[]


== ONE TO ONE ORTHOLOGS

anchor:chapter-configure[]
This section describes the REST endpoints for one to one orthologs in the system.
...
Curl:
include::{snippets}/by-mouse-genes/curl-request.adoc[]

===== Example Response

include::{snippets}/by-mouse-genes/http-response.adoc[]
...
Curl:
include::{snippets}/by-human-genes/curl-request.adoc[]

===== Example Response

include::{snippets}/by-human-genes/http-response.adoc[]
...
Curl:
include::{snippets}/by-mgi-accession-id/curl-request.adoc[]

===== Example Response

include::{snippets}/by-mgi-accession-ids/http-response.adoc[]
...
Curl:
include::{snippets}/by-hgnc-accession-id/curl-request.adoc[]

===== Example Response

include::{snippets}/by-hgnc-accession-ids/http-response.adoc[]
...
anchor:chapter-configure[]
This section describes the REST endpoints for one to many orthologs in the system.
...
Curl:
include::{snippets}/one-to-many-by-mgi-accession-id/curl-request.adoc[]

===== Example Response

include::{snippets}/one-to-many-by-mgi-accession-id/http-response.adoc[]


== Lastest updates

* 2022-06-01: - One to Many end point added
